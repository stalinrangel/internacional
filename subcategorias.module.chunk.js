...
var SubcategoriasAgregarComponent = /** @class */ (function () {
    ...
    SubcategoriasAgregarComponent.prototype.ciudades = function () {
        var _this = this;
...
var SubcategoriasVerComponent = /** @class */ (function () {
    ...
    SubcategoriasVerComponent.prototype.ciudades = function () {
        var _this = this;
        this.http.get(this.rutaService.getRutaApi() + 'ciudad?pais_id=' + localStorage.getItem('mouvers_pais') + '&token=' + localStorage.getItem('mouvers_token'))
            .toPromise()
            .then(function (data) {
